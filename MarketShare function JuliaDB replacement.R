...
#The G function is stored in a dataframe called g_func - he originally stored all of his stuff in a table but I that can only be done with juliadb
#The Marketshare function is stored in a dataframe called Market